...
#define BASEDATOS_TYPE_RESPALDO (basedatos_respaldo_get_type())

G_DECLARE_FINAL_TYPE (BasedatosRespaldo, basedatos_respaldo, BASEDATOS, RESPALDO, GObject)
